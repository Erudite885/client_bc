...
import image1 from "../assets/2151205418.jpg";
import image2 from "../assets/living-as-digital-nomad.jpg";
import image3 from "../assets/digital-nomad1.jpg";
import ceo_profile from "../assets/abt_person.svg";
...
export const faqs = [
  {
    question: "What is Brand Collaborator?",
    answer: (
      <>
        Brand Collaborator is a platform that connects brands with content creators, influencers, and freelancers to
        help them collaborate on various projects.
        <br />
        We offer services like <strong>content creation</strong>, <strong>UGC (User-Generated Content)</strong>, and
        more.
      </>
    ),
  },
  {
    ...
    answer: (
      <>
        You can sign up as a brand, content creator, or freelancer by clicking the <strong>"Sign Up"</strong> button on
        our homepage.
        <br />
        Fill in the required details and follow the instructions to complete your registration.
      </>
    ),
  },
  {
    ...
    answer: (
      <>
        <strong>For Brands:</strong> You’ll be required to deposit funds once you hire a content creator or freelancer.
        <br />
        Payments are securely handled through our platform.
        <br />
        <strong>For Creators and Freelancers:</strong> After successfully completing a project, you will receive your
        payment minus our service fee (10% for content creators, 20% for freelancers).
      </>
    ),
  },
  {
    question: "What fees does Brand Collaborator charge?",
    answer: (
      <>
        We charge a <strong>10% fee</strong> for content creators (UGC).
        <br />
        We charge a <strong>20% fee</strong> for freelancers.
      </>
    ),
  },
  {
    ...
    answer: (
      <>
        No, all payments made on Brand Collaborator are final.
        <br />
        Please ensure that you are satisfied with the agreement before making any payments.
      </>
    ),
  },
  {
    ...
    answer: (
      <>
        You can manage your account settings by logging into your dashboard.
        <br />
        Here, you can update your profile, payment information, and view your project history.
      </>
    ),
  },
  {
    question: "What should I do if I have an issue with a project?",
    answer: (
      <>
        If you encounter any problems during a project, please contact our support team immediately.
        <br />
        We are here to help resolve any issues promptly.
      </>
    ),
  },
  {
  ...
  {
    question: "What are cookies, and how does Brand Collaborator use them?",
    answer: (
      <>
        Cookies are small text files stored on your device by our website.
        <br />
        They help us improve your user experience by remembering your preferences and tracking how you use our site.
        <br />
  ...
  {
    question: "Where can I find the Terms and Policies?",
    answer: (
      <>
        You can access our{" "}
        <strong>
        ...
        , and other legal documents at the footer of our website.
      </>
    ),
  },
];
